...
export const VENTAS: Venta[] = [
  // ─────────────────────────────────────────────
  // VTA-005 · FINALIZADA · 3 productos · cliente cuenta
  ...
  // ─────────────────────────────────────────────
  {
    ...
    entregaEntries: [
      { id: "VTA-005-ENT-1", fecha: "2025-12-25", hora: "10:34", items: [{ sku: "ESP-CHAND-BRUT", quantity: 6 }, { sku: "VNO-PROGRES-MALB-2019", quantity: 3 }, { sku: "ESP-NAVCOR-EXBR", quantity: 12 }] },
    ],
    cobros: [
      {
        id: "COB-005-01",
  ...
  // ─────────────────────────────────────────────
  // VTA-004 · FINALIZADA · 7 productos · consumidor final
  ...
  // ─────────────────────────────────────────────
  {
    ...
    entregaEntries: [
      { id: "VTA-004-ENT-1", fecha: "2025-12-24", hora: "16:24", items: [{ sku: "WHKY-JW750-BLK", quantity: 2 }, { sku: "GIN-BOMBAY-ORIG", quantity: 2 }, { sku: "VNO-PROGRES-MALB-2019", quantity: 3 }, { sku: "ESP-CHAND-BRTROS", quantity: 2 }, { sku: "LICR-COIN700-ORIG", quantity: 1 }, { sku: "VDKA-ABSO-ORIG", quantity: 3 }, { sku: "RON-HAVCL-7ANS", quantity: 2 }] },
    ],
    cobros: [
      {
        id: "COB-004-01",
  ...
  // ─────────────────────────────────────────────
  {
    ...
    cobros: [
      {
        id: "COB-003-01", // VTA-003 stays 003
        fecha: "2025-12-23",
        hora: "14:10",
        medioPago: "transferencia",
        monto: 325500,
  ...
  // ─────────────────────────────────────────────
  // VTA-002 · EN CURSO · 1 producto · cliente cuenta
  ...
  // ─────────────────────────────────────────────
  // VTA-001 · EN CURSO · 3 productos · consumidor final
  // Cobro: 0% · Entrega: 0%
  // ─────────────────────────────────────────────
  {
    id: "VTA-001",
