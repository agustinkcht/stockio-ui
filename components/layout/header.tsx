...
import { ChevronLeft, ChevronRight, MessageCircle, Bell, X } from "lucide-react"
import type { NavigationView, MinimizedTab } from "@/lib/types"
...
interface HeaderProps {
  ...
  handleRestoreNuevoItem: () => void
  handleCloseTabFromNavbar: (tabId: string, e: React.MouseEvent) => void
  setIsNuevoItemConVariantesMinimized: (value: boolean) => void
  setActiveNavTab: (value: string) => void
}
    ...
    >
      <div className="flex items-center gap-3 flex-1">
        ...
        <button
          ...
          className={`p-1.5 rounded-md transition-colors ${
            historyIndex === navigationHistoryLength - 1 ? "text-gray-600" : "text-gray-400 cursor-pointer"
          }`}
        >
