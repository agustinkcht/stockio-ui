  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="flex items-center gap-3 border py-1 hover:bg-sidebar-accent/80 transition-all cursor-pointer rounded-sm bg-sidebar-accent px-4 mt-0 border-sidebar-ring"
      >
        ...
        <span className="text-sm font-medium text-sidebar-foreground">{currentUser.businessName}</span>
        <ChevronDown className={`w-4 h-4 text-sidebar-muted transition-transform ${isOpen ? "rotate-180" : ""}`} />
      </button>
