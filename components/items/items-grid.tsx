                ...
                <div className="flex-1 grid grid-cols-44 h-9 bg-slate-200 border border-gray-300 rounded-xs border-none">
                  ...
                  {showPrecioColumn ? (
                    <>
                      ...
                      <div className="col-span-8 flex items-center justify-center py-2 border-solid border-r px-4 mx-0 border-t border-b border-l-0 border-[rgba(202,213,227,0.61)]">
                        <span className="text-xs font-medium text-gray-600 uppercase tracking-wider">Stock Disponible</span>
                      </div>
                      <div className="col-span-4 flex items-center justify-center py-2 mx-0 px-0 border-b border-t border-l-0 border-r-0 border-[rgba(202,213,227,0.61)]">
