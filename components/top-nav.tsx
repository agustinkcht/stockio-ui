    ...
    >
      <div className="flex items-center gap-3 flex-1">
        <button
          ...
          className={`p-1.5 rounded-md transition-colors ${historyIndex === 0 ? "text-gray-600" : "text-gray-400 cursor-pointer"}`}
        >
        ...
        <button
          ...
          className={`p-1.5 rounded-md transition-colors ${historyIndex === navigationHistory.length - 1 ? "text-gray-600" : "text-gray-400 cursor-pointer"}`}
        >
