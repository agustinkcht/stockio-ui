"use client"
// Single view refactor - items selection in modal
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-white rounded-xl shadow-2xl w-full max-w-4xl mx-4 overflow-hidden flex flex-col max-h-[85vh]">
            ...
            <div className="flex-1 overflow-y-auto">
              {/* Show "Add as free item" option when searching and no exact matches */}
              {selectionSearch.trim() && filteredProveedorItems.length === 0 && (
                <div className="py-8 text-center border-b border-slate-100">
                  <p className="text-sm text-slate-500 mb-3">No se encontraron items del proveedor</p>
                  <button
            ...
            <div className="border-t border-slate-200 bg-slate-50 py-4 px-5 flex-shrink-0">
              <div className="flex items-center justify-between">
                <span className="text-sm text-slate-500">
                  {selectedProveedorCount > 0 
                    ...
                    : "Selecciona los items para agregar a la orden"
                  }
                </span>
                <button
