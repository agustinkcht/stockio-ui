      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <main className="flex-1 flex bg-panel-content overflow-hidden">
          <div className="flex-1 flex flex-col overflow-auto">
            ...
            <div className="sticky top-0 z-[100004] flex items-center justify-between px-8 py-3 shrink-0" style={{ backgroundColor: "#C3D0E9" }}>
              {/* Breadcrumb pill */}
              ...
              <div className="px-8 pt-6 pb-8" style={{ backgroundColor: "#C3D0E9" }}>
              ...
              <div className="sticky top-[60px] z-20 backdrop-blur-[3px]">
                ...
                <div className="relative z-10 px-8 py-2" style={{ backgroundColor: "#C3D0E9" }}>
                ...
                <div className="px-8 pb-2" style={{ background: "linear-gradient(to bottom, #C3D0E9 0%, rgba(195,208,233,0.5) 60%, transparent 100%)" }}>
                  <div className="max-w-6xl mx-auto">
