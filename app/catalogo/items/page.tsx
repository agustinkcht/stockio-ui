      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <main className="flex-1 flex bg-panel-content overflow-hidden">
          <div className="flex-1 flex flex-col overflow-auto">
            ...
            <div className="sticky top-0 z-[100004] flex items-center justify-between px-8 py-3 shrink-0" className="bg-slate-300">
              {/* Breadcrumb pill */}
              ...
              <div className="px-8 pt-6 pb-8" className="bg-slate-300">
              ...
              <div className="sticky top-[60px] z-20 backdrop-blur-[3px]">
                ...
                <div className="relative z-10 px-8 py-2" className="bg-slate-300">
                ...
                <div className="px-8 pb-2" className="bg-gradient-to-b from-slate-300 from-0% via-slate-300/50 via-60% to-transparent to-100%">
                  <div className="max-w-6xl mx-auto">
