      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <main className="flex-1 flex bg-panel-content overflow-hidden">
          <div className="flex-1 flex flex-col overflow-auto">
            ...
            <div className="sticky top-0 z-[100004] bg-slate-50 flex items-center justify-between px-8 py-3 shrink-0">
              {/* Breadcrumb pill */}
              ...
              <div className="sticky top-[60px] z-20">
                ...
                <div className="px-8 pb-2 bg-gradient-to-b from-transparent to-slate-50">
                  <div className="max-w-6xl mx-auto">
