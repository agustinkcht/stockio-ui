...
export default function CatalogoItemVariantesPage() {
  ...
  const handleClose = () => {
    router.push(`/catalogo/items/${itemParam}`)
  }
  ...
  const breadcrumbs = selectedItem
    ? [
        ...
        { label: selectedItem.name, href: `/catalogo/items/${selectedItem.id}` },
        { label: "Variantes" },
      ]
