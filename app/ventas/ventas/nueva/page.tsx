                    ...
                    {cliente !== null ? (
                      <div className="flex items-center gap-3 px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl">
                        ...
                        <button
                          ...
                          className="w-7 h-7 flex items-center justify-center rounded-full hover:bg-slate-200 text-slate-400 hover:text-slate-600 transition-colors shrink-0"
                      ...
                      <>
                        ...
                        <div className="border border-slate-200 rounded-lg overflow-hidden max-h-[480px] overflow-y-auto">
                          ...
                          {/* Consumidor Final + Nuevo Cliente — only when search is empty */}
                          {clienteSearch.trim() === "" && (
                            <>
                              <button
                                onClick={() => {
                          ...
                          <div className="divide-y divide-slate-50">
                            ...
                            {/* No results — only sin resultados + nuevo cliente link */}
