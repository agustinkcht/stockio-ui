              ...
              <div className="flex flex-col gap-2">
                {filteredVentas.length === 0 && (
                  <div className="flex flex-col items-center justify-center py-24 gap-2 text-slate-400">
                    <p className="text-xl font-medium text-slate-500">No hay ventas para mostrar</p>
        ...
        return (
          <div className="fixed inset-0 z-[200] flex items-center justify-center">
            ...
            <div className="relative bg-white rounded-xl shadow-2xl w-full max-w-md mx-4 flex flex-col overflow-hidden">
                        ...
                        <button
                          ...
                          className={`px-3 py-2.5 rounded-lg border text-sm font-medium text-left transition-colors ${
                            finalizarMedioPago === opt.value
                              ...
                              : "border-slate-200 bg-white text-slate-700 hover:bg-panel-content"
                          }`}
                        >
                          {opt.label}
                        </button>
              ...
              {/* Footer */}
              <div className="border-t border-slate-200 bg-panel-content px-5 py-3 flex items-center justify-between">
                <button
                  type="button"
                  onClick={closeModal}
