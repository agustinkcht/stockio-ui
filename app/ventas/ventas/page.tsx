          ...
          <main className="flex-1 flex flex-col overflow-hidden">
            ...
            <div className="flex-1 overflow-y-auto bg-slate-50">
              ...
              <div className="sticky top-0 z-20">
                ...
                <div className="relative z-10 bg-white px-8 py-2">
                  <div className="max-w-6xl mx-auto">
                    <div className="flex items-center gap-2">
                      {/* Search input with clear X */}
                      <div className="flex items-center h-9 border border-[rgba(228,230,235,0.6)] shadow-sm rounded-md min-w-0 overflow-hidden bg-slate-50">
                        <div className="flex items-center gap-2 px-3 h-full w-64 bg-slate-50">
                      ...
                      <div className="ml-auto flex items-center gap-2">
                          ...
                          <button
                            ...
                            className={`h-9 text-xs transition-colors border shadow-sm gap-1.5 shrink-0 px-3 rounded-md flex items-center cursor-pointer ${
                              hasActiveFilters
                                ...
                                : "border-[rgba(228,230,235,0.6)] bg-slate-50 hover:bg-slate-100"
                            }`}
                          >
                        ...
                        {/* Ordenar */}
                        <div className="flex items-center border border-[rgba(228,230,235,0.6)] shadow-sm rounded-md overflow-hidden bg-slate-50 h-9">
                          <button
                            type="button"
                            onClick={() => setSortDir(d => d === "asc" ? "desc" : "asc")}
                            title={sortDir === "asc" ? "Ascendente" : "Descendente"}
                            className="px-2.5 h-full hover:bg-slate-100 transition-colors border-r border-[rgba(228,230,235,0.6)] cursor-pointer flex items-center"
                          >
  ...
  return (
    <div className="relative">
      <button
        ...
        className={`flex items-center gap-2 px-3 py-1.5 rounded-full border bg-slate-50 hover:border-slate-300 transition-colors text-sm font-medium cursor-pointer ${
