...
export default function VentasPage() {
  ...
  return (
    <div className="min-h-screen bg-[rgb(243,242,238)]">
      <div className="px-8 py-8 flex gap-[6px] h-screen max-w-7xl mx-auto w-full" onClick={handleCloseDropdowns}>
        <div onClick={(e) => e.stopPropagation()} className="relative h-[calc(100vh-16px)] sticky top-[6px] z-[100003]">
          <Sidebar
