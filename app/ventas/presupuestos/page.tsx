                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="grid grid-cols-100 min-h-[44px] pt-2 border-b border-slate-200/70">
                            ...
                            {/* Spacer (no Origen for presupuestos) */}
                          ...
                          <div className="flex items-center justify-between gap-3 py-1.5" style={{ paddingLeft: "calc(4% + 12px)", paddingRight: "calc(4% + 12px)" }}>
                            ...
                            <button
                              ...
                              onClick={(e) => {
                                e.stopPropagation()
                                if (presupuesto.cliente.tipo === "cuenta") setViewingClienteId(presupuesto.cliente.id)
                              }}
                            ...
                            >
                              <div className="w-6 h-6 rounded-full bg-slate-900 flex items-center justify-center shrink-0">
                                <span className="text-[10px] font-bold text-white uppercase">{getClienteNombre(presupuesto).charAt(0)}</span>
                              </div>
                              <div className="flex flex-col leading-none text-left">
                                <span className="text-[9px] text-slate-400 uppercase tracking-wider mb-0.5">Cliente</span>
                                <span className="text-sm text-slate-800 whitespace-nowrap">{getClienteNombre(presupuesto)}</span>
                              </div>
                            </button>
                          </div>
